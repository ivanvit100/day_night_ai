var rus = ["Приветствую!", "На данной странице Вы можете ознакомиться с примером использования искусственного интеллекта, обученного методом Q-learning, в браузере.", "Автор: Иванущенко Виталий", "", "", "", "", "", "Изображение", "Выбрать фото", "Предсказать", "Теория", "2021-2022 Иванущенко Виталий", "Нажмите, чтобы продолжить!", "Узнать результат!", "Теория и исходный код модели!", "Гайд", "Далее", "Назад", "Готово"];
var en = ["Greetings!", "On this page you can see an example of using Q-learning artificial intelligence in a browser.", "Author: Ivanushenko Vitaliy", "", "", "", "", "", "Image", "Select image", "Predict", "Theory", "2021-2022 Ivanushenko Vitaliy", "Click to continue!", "Find out the result!", "Theory and source code of the model!", "Guide", "Next", "Back", "Done"];
